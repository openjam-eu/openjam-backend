...
module.exports = {
  ...
  fetch: params => {
    ...
    return Comment.findOne(
      _.pick(params, _.keys(Comment.schema.paths))
    ).populate(populate);
  },
  ...
  count: params => {
    ...
    return Comment.countDocuments().where(filters.where);
  },
  ...
  add: async values => {
    ...
    const relations = _.pick(
      values,
      Comment.associations.map(ast => ast.alias)
    );
  ...
  edit: async (params, values) => {
    ...
    return Comment.updateRelations(
  ...
  remove: async params => {
    ...
    const data = await Comment.findOneAndRemove(params, {}).populate(populate);
