...
module.exports = {
  ...
  fetch: params => {
    ...
    return Label.findOne(_.pick(params, _.keys(Label.schema.paths))).populate(
      populate
    );
  },
  ...
  count: params => {
    ...
    return Label.countDocuments().where(filters.where);
  },
  ...
  remove: async params => {
    ...
    const data = await Label.findOneAndRemove(params, {}).populate(populate);
