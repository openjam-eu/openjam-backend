...
module.exports = {
  ...
  fetch: params => {
    ...
    return Style.findOne(_.pick(params, _.keys(Style.schema.paths))).populate(
      populate
    );
  },
  ...
  count: params => {
    ...
    return Style.countDocuments().where(filters.where);
  },
  ...
  remove: async params => {
    ...
    const data = await Style.findOneAndRemove(params, {}).populate(populate);
