...
module.exports = {
  ...
  fetch: params => {
    ...
    return Post.findOne(_.pick(params, _.keys(Post.schema.paths))).populate(
      populate
    );
  },
  ...
  count: params => {
    ...
    return Post.countDocuments().where(filters.where);
  },
  ...
  remove: async params => {
    ...
    const data = await Post.findOneAndRemove(params, {}).populate(populate);
